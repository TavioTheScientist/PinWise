...
///
/// The copy is byte-for-byte the Swift `Disclaimer`: Swift's `"""` blocks end each line with
/// a backslash, which strips the newline and leaves a single space, so every constant here is
/// ONE line assembled from adjacent literals. Do not reflow — the strings are shown to users
/// and compared against the iOS build.
abstract final class Disclaimer {
  ...
  static const String researchCompound =
  ...
  static const String onboarding =
      'Staxyz is a personal tracking and organization tool. It is not a medical device, '
  ...
  static const String exportFooter =
      'Generated by Staxyz for personal record-keeping. Not medical advice. '
